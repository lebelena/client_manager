...
Подсистема содержит **все документы, с помощью которых было оформлено то или иное поступление товара в любое доступное для вас пространство.**
...
Подсистема содержит **все документы, с помощью которых было оформлено списание товара из любого доступного для вас пространства.**
